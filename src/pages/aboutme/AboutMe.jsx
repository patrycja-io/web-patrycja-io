          ...
          <div class="container mx-auto px-6 flex flex-col justify-between items-center relative py-4">
            <div class="flex flex-col">
              ...
              <h2 class="max-w-3xl text-5xl md:text-2xl  mx-auto dark:text-white text-gray-800 text-center py-2">
                ...
                <br />
                I am as well as former journalist who was passionate about coding
                ...
                reels and Youtube.
                <br /> <br />I am here to help you change your career like I
                did. As well as to bring you the most free resources that I
                could find and wrap it up in one place.
              </h2>

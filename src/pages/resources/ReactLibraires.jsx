export default function ReactLibraires() {
  return (
    <div>
    ...
    <div className="max-w-xl">
      ...
      <p className="mt-4 sm:text-2xl">
        Enter to the world of free learning and resources!
      </p>
    </div>
    <ul className="border border-white sm:grid sm:grid-cols-2 lg:grid-cols-3">

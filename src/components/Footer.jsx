...
export default function Footer (){
  ...
  <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <nav
        className="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold border-4 border-black rounded-xl"
      >
        <a
          className="hover:opacity-75"
          href="https://patrycja.io"
          target="_blank"
          rel="noopener noreferrer"
        >
          patrycja.io
      ...
      <p className="text-xs font-medium">2022 Patrycja Tyra</p>
    </div>
  </div>
</footer>
